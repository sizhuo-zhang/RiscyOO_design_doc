...
\begin{itemize}
    ...
    This communication is using the HTIF protocol, which is used in the RISC-V ISA simulator Spike (\url{https://github.com/riscv/riscv-isa-sim}, our fork of spike is at \code{//tools/riscv-isa-sim}).
...
\end{itemize}
The communication between FPGA and x86 software via PCIe is using the Connectal framework (\url{http://www.connectal.org/}, our fork of the Connectal project is at \code{//connectal}).
